...
1. **Индексация:**
   - Текст разбивается на чанки размером 500-1000 токенов
   - Между чанками делается перекрытие 50-100 токенов
