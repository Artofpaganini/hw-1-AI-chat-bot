...
class RagIndexer(private val projectRoot: File, private val indexDbPath: File) {
        ...
        try {
            ...
            kotlinFiles.forEach { file ->
                try {
                    ...
                    logger.warning("Failed to index file ${file.path}: ${e.message}")
                }
            }
    ...
    fun searchContext(query: String, topK: Int = 5): List<IndexedChunk> {
        ...
        try {
            ...
            val queryEmbeddingBytes = queryEmbedding.toByteArray()
    ...
    private fun CodeEmbedder.toByteArray(embedding: FloatArray): ByteArray {
        return embedder.toByteArray(embedding)
    }
}
